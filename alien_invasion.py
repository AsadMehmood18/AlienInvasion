...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.sb = Scoreboard(self)                                      # Create an instance of the Scoreboard class.
    ...
    def _check_bullet_alien_collisions(self):
        collisions = pygame.sprite.groupcollide(self.bullets, self.aliens, True, True) # Check for any bullets that have hit aliens.
        
        if collisions:
            for aliens in collisions.values():
                self.stats.score += self.settings.alien_points * len(aliens) # Each alien in the collisions.values() is worth 50 points.
            self.sb.prep_score()
    ...
    def _update_screen(self):
        self.screen.blit(self.settings.bg, (0,0))                        # Redraw the screen during each pass through the loop.
